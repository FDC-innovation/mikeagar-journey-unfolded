...
const BusinessSection = () => {
  ...
  const companies = [
    "Verizon", "JP Morgan", "Salesforce", "Google Cloud", "Microsoft", "Oracle"
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Fast Data Connect represents the culmination of decades of experience, 
            innovation, and a vision to transform how businesses leverage technology.
          </p>
        </div>
            ...
            <Card className="overflow-hidden shadow-medium">
              ...
              >
                ...
                <div className="absolute bottom-4 left-4 text-primary-foreground">
                  <h3 className="font-serif text-2xl font-bold">Fast Data Connect</h3>
                  <p className="text-primary-foreground/90">Transforming Business Through Technology</p>
                </div>
              </div>
              ...
              <CardContent className="p-6">
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  Fast Data Connect has become a trusted partner for enterprises seeking digital transformation.
                </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {achievements.map((achievement, index) => (
                <Card key={index} className="text-center p-6 hover:shadow-medium transition-all duration-300 group">
                  <div className="text-3xl font-bold text-primary group-hover:text-gold transition-colors">
                    {achievement.metric}
                  </div>
          ...
          <div className="space-y-8">
            ...
            <Card className="p-6 bg-gradient-to-br from-primary/5 to-gold/5 border-gold/20">
              ...
              <p className="text-muted-foreground leading-relaxed italic">
                "Technology should empower, not complicate. Our mission is to make enterprise-grade 
                solutions accessible and practical for businesses of all sizes."
              </p>
              <p className="text-sm text-gold mt-2 font-medium">- Mike Agar, CEO</p>
            </Card>
          </div>
        </div>
          ...
          <Card className="inline-block p-8 shadow-medium hover:shadow-gold transition-all duration-500">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="text-left">
                <h3 className="font-serif text-xl font-semibold text-primary">Ready to Transform?</h3>
                <p className="text-muted-foreground">Let's discuss your business needs</p>
              </div>
            </div>
