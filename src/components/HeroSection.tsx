      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center lg:text-left">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold text-primary-foreground leading-tight">
                ...
                <span className="text-[#56bcbd] block animate-shimmer bg-gradient-to-r from-gold via-gold-light to-gold bg-[length:200%_100%] bg-clip-text ">
                  World
                </span>
              </h1>
            ...
            <p className="text-lg md:text-xl text-primary-foreground/80 max-w-2xl leading-relaxed">
              A voice that once echoed through Bollywood, now drives innovation
          ...
          <div className="hidden lg:block relative">
            ...
            <div
              className="absolute bottom-20 left-10 w-24 h-24 bg-primary-light/30 rounded-full animate-float blur-lg"
              style={{ animationDelay: "1s" }}
            ></div>
            <div
              className="absolute top-1/2 right-1/4 w-16 h-16 bg-gold/30 rounded-full animate-float blur-md"
